...
Official code release for the paper **"Offline Reinforcement Learning for
Distribution-Grid Protection,"** accepted at **PESS 2026** (IEEE Power and
Energy Student Summit), Karlsruhe, Germany, 21–23 October 2026.
...
[![arXiv](https://img.shields.io/badge/arXiv-2609.24703-b31b1b.svg)](https://arxiv.org/abs/2609.24703)
...
The default `combined_W48` run (30 epochs, seed 0) was trained on a single
NVIDIA A100-SXM4-40GB MIG `3g.20gb` instance with 16 CPU cores. Figures below
are measured from Slurm job accounting and the run's own logs, not from the
`04:00:00` Slurm wall-time limit in [`gate4/gate4.sbatch`](gate4/gate4.sbatch),
which is a request, not a measured duration:

| Quantity | Value |
|---|---|
| Elapsed wall-clock time | ≈1h 03m (comparable `combined_W48_*` reward-shaping variants: 58m–1h 05m) |
| Maximum resident host memory | ≈48.6 GiB |
| Peak GPU memory | not recoverable from existing logs |
| Trainable parameters | 853,604 (printed by the training code; independently verified from the committed model definition) |
...
The paper has been accepted at PESS 2026 (IEEE Power and Energy Student
Summit), Karlsruhe, Germany, 21–23 October 2026. Full bibliographic metadata
(volume, pages, DOI) will be added once the proceedings entry is available.
Until then, cite the accepted manuscript or the preprint:

```bibtex
@inproceedings{oelhaf2026offline,
  ...
  booktitle = {PESS 2026; IEEE Power and Energy Student Summit},
  year      = {2026},
  url       = {https://github.com/julianoelhaf/offline-cql-protection},
  note      = {Accepted. Preprint: arXiv:2609.24703. Julian Oelhaf and
               Alexander Luce contributed equally.}
}
```

Preprint: [arXiv:2609.24703](https://arxiv.org/abs/2609.24703).
